...
#include "mainspace/msg/detail/encoder_speed__rosidl_typesupport_fastrtps_c.h"
...
using _EncoderSpeed__ros_msg_type = mainspace__msg__EncoderSpeed;
  ...
  void * untyped_ros_message)
{
  ...
  _EncoderSpeed__ros_msg_type * ros_message = static_cast<_EncoderSpeed__ros_msg_type *>(untyped_ros_message);
  // Field name: fl
  {
    cdr >> ros_message->fl;
  }
...
size_t get_serialized_size_mainspace__msg__EncoderSpeed(
  const void * untyped_ros_message,
...
static uint32_t _EncoderSpeed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mainspace__msg__EncoderSpeed(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mainspace
size_t max_serialized_size_mainspace__msg__EncoderSpeed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mainspace__msg__EncoderSpeed;
    is_plain =
      (
...
static size_t _EncoderSpeed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mainspace__msg__EncoderSpeed(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mainspace, msg, EncoderSpeed)() {
