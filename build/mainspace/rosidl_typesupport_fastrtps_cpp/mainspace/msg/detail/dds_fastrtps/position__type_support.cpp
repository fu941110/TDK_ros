...
#include "mainspace/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mainspace::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mainspace::msg::Position & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mainspace::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mainspace::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mainspace::msg::Position *>(
    untyped_ros_message);
...
{
  return &mainspace::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mainspace, msg, Position)() {
  return &mainspace::msg::typesupport_fastrtps_cpp::_Position__handle;
}
