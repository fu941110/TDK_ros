...
bool mainspace__msg__to_stm_speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mainspace.msg._to_stm_speed.ToStmSpeed", full_classname_dest, 38) == 0);
  }
  mainspace__msg__ToStmSpeed * ros_message = _ros_message;
  {  // vx
...
{
  /* NOTE(esteve): Call constructor of ToStmSpeed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mainspace.msg._to_stm_speed");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ToStmSpeed");
